        ...
        <>
            ...
            <img src={midfootsImg} className='w-full h-full blur-xs object-cover'/>
                <div className='absolute top-0 w-full h-full inset-0 bg-black/55 flex item-center flex-col text-center'>
                    ...
                    <p className='mb-5 text-gray-200 mt-3 lg:text-[15px] md:ml-18 text-sm w-[70%] lg:w-full ml-15 lg:ml-0'>
                        Experience premium cleaning services designed to make your space sparkle inside and out.
                    </p>
                    <motion.button {...scrollToLeft} {...cardClicksEffects} className='absolute top-42 bg-[#80ECC9] outline-none hover:rounded-md transition-all hover:shadow-lg font-semibold px-7 lg:px-10 py-3 left-[25%] md:left-[35%] lg:left-[40%] cursor-pointer text-[#0077B6]'>Book our Services Now</motion.button>
                </div>
            </div>
        </>
    );
