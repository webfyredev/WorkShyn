...
import { cardClicksEffects, cardHover, scrollToLeft, scrollToRight } from "../effects/motion";
                ...
                <div className="w-full lg:h-150 md:h-auto h-auto flex md:flex-col sm:flex-col flex-col lg:flex-row p-5 items-center justify-center bg-[#F9FAFB]">
                    ...
                    <motion.div {...scrollToLeft} className="lw-full g:w-[50%] h-full lg:px-10 py-5 bg-white">
                        ...
                        <form action="" className="w-full h-auto flex flex-col py-5 mt-2">
                            ...
                            <label htmlFor="" className="text-sm my-1 text-[#0077B6]">Phone Number</label>
                            <input type="text" placeholder="Phone number"  className="h-11 px-2 outline-none border-1 border-[#4CE0B7] text-[#0077B6] text-sm hover:border-2 hover:rounded-sm transition-all mb-2"/>
